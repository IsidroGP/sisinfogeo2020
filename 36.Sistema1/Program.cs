...
namespace _36.Sistema1{
    class Program{
        ...
        static void Menu(){
            ...
            Console.WriteLine("[-] Visualizar el proceso acual............[3]");
        ...
        static void InfoSistema(){
            ...
            Console.WriteLine($"Usuario actio           : {Environment.UserName}");
            ...
            foreach(DictionaryEntry var in Environment.GetEnvironmentVariables()) Console.WriteLine($"{var.Key,-35} = {var.Value}\n");
        }
        ...
        static void ProcesoActual(){
            ...
            Console.WriteLine("El procesos que se ejecuta actualmente:");
        ...
        static void HilosyModulos(int proceso){
            try{
                ...
                Console.WriteLine($"\n>> Hilos en estre proceso:{hilos.Count}");
